...
export default function ResultCard({ title, snippet, score, path, matchedTerms, onOpen, onDeepDive }) {
  ...
  return (
    ...
    >
      ...
      <div className="search-result-actions">
        {onDeepDive && (
          <button 
            className="search-result-deepdive-btn" 
            onClick={handleDeepDive}
            title="Start DeepDive with this file"
          >
